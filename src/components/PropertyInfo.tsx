...
const PropertyInfo = ({ property }: PropertyInfoProps) => {
  const formatPrice = (price: number) => {
    // Since our Redux Property type uses 'approved' status, we'll just show the price
      ...
      <div className="property-card p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-t border-b">
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-foreground">{property.property_type}</div>
        ...
        <div className="bg-muted rounded-lg h-64 overflow-hidden">
          {property.map_image ? (
            ...
            <iframe
              ...
              src={`https://www.google.com/maps?q=${encodeURIComponent(property.location)}&hl=en&z=14&output=embed`}
            />
          )}
        </div>
